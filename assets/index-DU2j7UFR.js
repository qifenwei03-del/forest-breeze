...
`,$f=8,Xa=.15,Xi={midPx:2.6,strongPx:6.5},qa={mid:0,strong:90},Ya=20,qi={staticStart:.1,staticEnd:.42,strongStart:.58,strongEnd:.9},Zf=2,jf={maxRenderSize:4096},Co={mipmaps:!0,anisotropy:16},hn={forest:"forest.png",mask:"movement-mask.png"},dn={whiteAmount:1,grayAmount:.55,color:[.95,.96,.96],contrast:1.8,luma:.25,scale:2,drift:.6},nt={windStrength:.15,windDirection:0,animationSpeed:1,movementScale:1,fogStrength:.28,fogSpeed:1.5,movementMode:"ADVANCED",maskEnabled:!0,paused:!1},Jf=`${qf}
