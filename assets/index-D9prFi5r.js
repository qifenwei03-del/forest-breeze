...
`)+`
`+u);const E=T+h+a,A=T+u+o,z=Na(r,r.VERTEX_SHADER,E),P=Na(r,r.FRAGMENT_SHADER,A);r.attachShader(M,z),r.attachShader(M,P),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function b(S){if(i.debug.checkShaderErrors){const V=r.getProgramInfoLog(M).trim(),w=r.getShaderInfoLog(z).trim(),O=r.getShaderInfoLog(P).trim();let W=!0,G=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(W=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,z,P);else{const $=Fa(r,z,"vertex"),H=Fa(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`;class Bf{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const r=new ut,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!=n.depthNear||t.depthFar!=n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new tn({vertexShader:Ff,fragmentShader:Of,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ht(new Si(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class zf extends si{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,d=null,p=null,f=null,m=null,x=null;const M=new Bf,h=t.getContextAttributes();let u=null,T=null;const E=[],A=[],z=new Fe;let P=null;const b=new Nt;b.layers.enable(1),b.viewport=new et;const N=new Nt;N.layers.enable(2),N.viewport=new et;const Z=[b,N],g=new If;g.layers.enable(1),g.layers.enable(2);let S=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let J=E[X];return J===void 0&&(J=new Vr,E[X]=J),J.getTargetRaySpace()},this.getControllerGrip=function(X){let J=E[X];return J===void 0&&(J=new Vr,E[X]=J),J.getGripSpace()},this.getHand=function(X){let J=E[X];return J===void 0&&(J=new Vr,E[X]=J),J.getHandSpace()};function w(X){const J=A.indexOf(X.inputSource);if(J===-1)return;const pe=E[J];pe!==void 0&&(pe.update(X.inputSource,X.frame,c||a),pe.dispatchEvent({type:X.type,data:X.inputSource}))}function O(){r.removeEventListener("select",w),r.removeEventListener("selectstart",w),r.removeEventListener("selectend",w),r.removeEventListener("squeeze",w),r.removeEventListener("squeezestart",w),r.removeEventListener("squeezeend",w),r.removeEventListener("end",O),r.removeEventListener("inputsourceschange",W);for(let X=0;X<E.length;X++){const J=A[X];J!==null&&(A[X]=null,E[X].disconnect(J))}S=null,V=null,M.reset(),e.setRenderTarget(u),m=null,f=null,p=null,r=null,T=null,We.stop(),n.isPresenting=!1,e.setPixelRatio(P),e.setSize(z.width,z.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){s=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return p},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(X){if(r=X,r!==null){if(u=e.getRenderTarget(),r.addEventListener("select",w),r.addEventListener("selectstart",w),r.addEventListener("selectend",w),r.addEventListener("squeeze",w),r.addEventListener("squeezestart",w),r.addEventListener("squeezeend",w),r.addEventListener("end",O),r.addEventListener("inputsourceschange",W),h.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(z),r.renderState.layers===void 0){const J={antialias:h.antialias,alpha:!0,depth:h.depth,stencil:h.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,J),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),T=new Pn(m.framebufferWidth,m.framebufferHeight,{format:Pt,type:Qt,colorSpace:e.outputColorSpace,stencilBuffer:h.stencil})}else{let J=null,pe=null,ce=null;h.depth&&(ce=h.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,J=h.stencil?ii:jn,pe=h.stencil?ni:Cn);const Re={colorFormat:t.RGBA8,depthFormat:ce,scaleFactor:s};p=new XRWebGLBinding(r,t),f=p.createProjectionLayer(Re),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),T=new Pn(f.textureWidth,f.textureHeight,{format:Pt,type:Qt,depthTexture:new To(f.textureWidth,f.textureHeight,pe,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:h.stencil,colorSpace:e.outputColorSpace,samples:h.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),We.setContext(r),We.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function W(X){for(let J=0;J<X.removed.length;J++){const pe=X.removed[J],ce=A.indexOf(pe);ce>=0&&(A[ce]=null,E[ce].disconnect(pe))}for(let J=0;J<X.added.length;J++){const pe=X.added[J];let ce=A.indexOf(pe);if(ce===-1){for(let Me=0;Me<E.length;Me++)if(Me>=A.length){A.push(pe),ce=Me;break}else if(A[Me]===null){A[Me]=pe,ce=Me;break}if(ce===-1)break}const Re=E[ce];Re&&Re.connect(pe)}}const G=new B,$=new B;function H(X,J,pe){G.setFromMatrixPosition(J.matrixWorld),$.setFromMatrixPosition(pe.matrixWorld);const ce=G.distanceTo($),Re=J.projectionMatrix.elements,Me=pe.projectionMatrix.elements,Ue=Re[14]/(Re[10]-1),qe=Re[14]/(Re[10]+1),Ie=(Re[9]+1)/Re[5],R=(Re[9]-1)/Re[5],Mt=(Re[8]-1)/Re[0],Le=(Me[8]+1)/Me[0],Oe=Ue*Mt,ye=Ue*Le,$e=ce/(-Mt+Le),be=$e*-Mt;if(J.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(be),X.translateZ($e),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Re[10]===-1)X.projectionMatrix.copy(J.projectionMatrix),X.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{const y=Ue+$e,_=qe+$e,U=Oe-be,Y=ye+(ce-be),j=Ie*qe/_*y,q=R*qe/_*y;X.projectionMatrix.makePerspective(U,Y,j,q,y,_),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function se(X,J){J===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(J.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(r===null)return;let J=X.near,pe=X.far;M.texture!==null&&(M.depthNear>0&&(J=M.depthNear),M.depthFar>0&&(pe=M.depthFar)),g.near=N.near=b.near=J,g.far=N.far=b.far=pe,(S!==g.near||V!==g.far)&&(r.updateRenderState({depthNear:g.near,depthFar:g.far}),S=g.near,V=g.far);const ce=X.parent,Re=g.cameras;se(g,ce);for(let Me=0;Me<Re.length;Me++)se(Re[Me],ce);Re.length===2?H(g,b,N):g.projectionMatrix.copy(b.projectionMatrix),le(X,g,ce)};function le(X,J,pe){pe===null?X.matrix.copy(J.matrixWorld):(X.matrix.copy(pe.matrixWorld),X.matrix.invert(),X.matrix.multiply(J.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(J.projectionMatrix),X.projectionMatrixInverse.copy(J.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=Cs*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return g},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(X){l=X,f!==null&&(f.fixedFoveation=X),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=X)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(g)};let ge=null;function ze(X,J){if(d=J.getViewerPose(c||a),x=J,d!==null){const pe=d.views;m!==null&&(e.setRenderTargetFramebuffer(T,m.framebuffer),e.setRenderTarget(T));let ce=!1;pe.length!==g.cameras.length&&(g.cameras.length=0,ce=!0);for(let Me=0;Me<pe.length;Me++){const Ue=pe[Me];let qe=null;if(m!==null)qe=m.getViewport(Ue);else{const R=p.getViewSubImage(f,Ue);qe=R.viewport,Me===0&&(e.setRenderTargetTextures(T,R.colorTexture,f.ignoreDepthValues?void 0:R.depthStencilTexture),e.setRenderTarget(T))}let Ie=Z[Me];Ie===void 0&&(Ie=new Nt,Ie.layers.enable(Me),Ie.viewport=new et,Z[Me]=Ie),Ie.matrix.fromArray(Ue.transform.matrix),Ie.matrix.decompose(Ie.position,Ie.quaternion,Ie.scale),Ie.projectionMatrix.fromArray(Ue.projectionMatrix),Ie.projectionMatrixInverse.copy(Ie.projectionMatrix).invert(),Ie.viewport.set(qe.x,qe.y,qe.width,qe.height),Me===0&&(g.matrix.copy(Ie.matrix),g.matrix.decompose(g.position,g.quaternion,g.scale)),ce===!0&&g.cameras.push(Ie)}const Re=r.enabledFeatures;if(Re&&Re.includes("depth-sensing")){const Me=p.getDepthInformation(pe[0]);Me&&Me.isValid&&Me.texture&&M.init(e,Me,r.renderState)}}for(let pe=0;pe<E.length;pe++){const ce=A[pe],Re=E[pe];ce!==null&&Re!==void 0&&Re.update(ce,J,c||a)}ge&&ge(X,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),x=null}const We=new yo;We.setAnimationLoop(ze),this.setAnimationLoop=function(X){ge=X},this.dispose=function(){}}}const En=new en,Hf=new st;function Gf(i,e){function t(h,u){h.matrixAutoUpdate===!0&&h.updateMatrix(),u.value.copy(h.matrix)}function n(h,u){u.color.getRGB(h.fogColor.value,So(i)),u.isFog?(h.fogNear.value=u.near,h.fogFar.value=u.far):u.isFogExp2&&(h.fogDensity.value=u.density)}function r(h,u,T,E,A){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(h,u):u.isMeshToonMaterial?(s(h,u),p(h,u)):u.isMeshPhongMaterial?(s(h,u),d(h,u)):u.isMeshStandardMaterial?(s(h,u),f(h,u),u.isMeshPhysicalMaterial&&m(h,u,A)):u.isMeshMatcapMaterial?(s(h,u),x(h,u)):u.isMeshDepthMaterial?s(h,u):u.isMeshDistanceMaterial?(s(h,u),M(h,u)):u.isMeshNormalMaterial?s(h,u):u.isLineBasicMaterial?(a(h,u),u.isLineDashedMaterial&&o(h,u)):u.isPointsMaterial?l(h,u,T,E):u.isSpriteMaterial?c(h,u):u.isShadowMaterial?(h.color.value.copy(u.color),h.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(h,u){h.opacity.value=u.opacity,u.color&&h.diffuse.value.copy(u.color),u.emissive&&h.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(h.map.value=u.map,t(u.map,h.mapTransform)),u.alphaMap&&(h.alphaMap.value=u.alphaMap,t(u.alphaMap,h.alphaMapTransform)),u.bumpMap&&(h.bumpMap.value=u.bumpMap,t(u.bumpMap,h.bumpMapTransform),h.bumpScale.value=u.bumpScale,u.side===St&&(h.bumpScale.value*=-1)),u.normalMap&&(h.normalMap.value=u.normalMap,t(u.normalMap,h.normalMapTransform),h.normalScale.value.copy(u.normalScale),u.side===St&&h.normalScale.value.negate()),u.displacementMap&&(h.displacementMap.value=u.displacementMap,t(u.displacementMap,h.displacementMapTransform),h.displacementScale.value=u.displacementScale,h.displacementBias.value=u.displacementBias),u.emissiveMap&&(h.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,h.emissiveMapTransform)),u.specularMap&&(h.specularMap.value=u.specularMap,t(u.specularMap,h.specularMapTransform)),u.alphaTest>0&&(h.alphaTest.value=u.alphaTest);const T=e.get(u),E=T.envMap,A=T.envMapRotation;E&&(h.envMap.value=E,En.copy(A),En.x*=-1,En.y*=-1,En.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(En.y*=-1,En.z*=-1),h.envMapRotation.value.setFromMatrix4(Hf.makeRotationFromEuler(En)),h.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,h.reflectivity.value=u.reflectivity,h.ior.value=u.ior,h.refractionRatio.value=u.refractionRatio),u.lightMap&&(h.lightMap.value=u.lightMap,h.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,h.lightMapTransform)),u.aoMap&&(h.aoMap.value=u.aoMap,h.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,h.aoMapTransform))}function a(h,u){h.diffuse.value.copy(u.color),h.opacity.value=u.opacity,u.map&&(h.map.value=u.map,t(u.map,h.mapTransform))}function o(h,u){h.dashSize.value=u.dashSize,h.totalSize.value=u.dashSize+u.gapSize,h.scale.value=u.scale}function l(h,u,T,E){h.diffuse.value.copy(u.color),h.opacity.value=u.opacity,h.size.value=u.size*T,h.scale.value=E*.5,u.map&&(h.map.value=u.map,t(u.map,h.uvTransform)),u.alphaMap&&(h.alphaMap.value=u.alphaMap,t(u.alphaMap,h.alphaMapTransform)),u.alphaTest>0&&(h.alphaTest.value=u.alphaTest)}function c(h,u){h.diffuse.value.copy(u.color),h.opacity.value=u.opacity,h.rotation.value=u.rotation,u.map&&(h.map.value=u.map,t(u.map,h.mapTransform)),u.alphaMap&&(h.alphaMap.value=u.alphaMap,t(u.alphaMap,h.alphaMapTransform)),u.alphaTest>0&&(h.alphaTest.value=u.alphaTest)}function d(h,u){h.specular.value.copy(u.specular),h.shininess.value=Math.max(u.shininess,1e-4)}function p(h,u){u.gradientMap&&(h.gradientMap.value=u.gradientMap)}function f(h,u){h.metalness.value=u.metalness,u.metalnessMap&&(h.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,h.metalnessMapTransform)),h.roughness.value=u.roughness,u.roughnessMap&&(h.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,h.roughnessMapTransform)),u.envMap&&(h.envMapIntensity.value=u.envMapIntensity)}function m(h,u,T){h.ior.value=u.ior,u.sheen>0&&(h.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),h.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(h.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,h.sheenColorMapTransform)),u.sheenRoughnessMap&&(h.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,h.sheenRoughnessMapTransform))),u.clearcoat>0&&(h.clearcoat.value=u.clearcoat,h.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(h.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,h.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(h.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,h.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(h.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,h.clearcoatNormalMapTransform),h.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===St&&h.clearcoatNormalScale.value.negate())),u.dispersion>0&&(h.dispersion.value=u.dispersion),u.iridescence>0&&(h.iridescence.value=u.iridescence,h.iridescenceIOR.value=u.iridescenceIOR,h.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],h.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(h.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,h.iridescenceMapTransform)),u.iridescenceThicknessMap&&(h.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,h.iridescenceThicknessMapTransform))),u.transmission>0&&(h.transmission.value=u.transmission,h.transmissionSamplerMap.value=T.texture,h.transmissionSamplerSize.value.set(T.width,T.height),u.transmissionMap&&(h.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,h.transmissionMapTransform)),h.thickness.value=u.thickness,u.thicknessMap&&(h.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,h.thicknessMapTransform)),h.attenuationDistance.value=u.attenuationDistance,h.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(h.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(h.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,h.anisotropyMapTransform))),h.specularIntensity.value=u.specularIntensity,h.specularColor.value.copy(u.specularColor),u.specularColorMap&&(h.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,h.specularColorMapTransform)),u.specularIntensityMap&&(h.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,h.specularIntensityMapTransform))}function x(h,u){u.matcap&&(h.matcap.value=u.matcap)}function M(h,u){const T=e.get(u).light;h.referencePosition.value.setFromMatrixPosition(T.matrixWorld),h.nearDistance.value=T.shadow.camera.near,h.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function kf(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,E){const A=E.program;n.uniformBlockBinding(T,A)}function c(T,E){let A=r[T.id];A===void 0&&(x(T),A=d(T),r[T.id]=A,T.addEventListener("dispose",h));const z=E.program;n.updateUBOMapping(T,z);const P=e.render.frame;s[T.id]!==P&&(f(T),s[T.id]=P)}function d(T){const E=p();T.__bindingPointIndex=E;const A=i.createBuffer(),z=T.__size,P=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,A),i.bufferData(i.UNIFORM_BUFFER,z,P),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,A),A}function p(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(T){const E=r[T.id],A=T.uniforms,z=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let P=0,b=A.length;P<b;P++){const N=Array.isArray(A[P])?A[P]:[A[P]];for(let Z=0,g=N.length;Z<g;Z++){const S=N[Z];if(m(S,P,Z,z)===!0){const V=S.__offset,w=Array.isArray(S.value)?S.value:[S.value];let O=0;for(let W=0;W<w.length;W++){const G=w[W],$=M(G);typeof G=="number"||typeof G=="boolean"?(S.__data[0]=G,i.bufferSubData(i.UNIFORM_BUFFER,V+O,S.__data)):G.isMatrix3?(S.__data[0]=G.elements[0],S.__data[1]=G.elements[1],S.__data[2]=G.elements[2],S.__data[3]=0,S.__data[4]=G.elements[3],S.__data[5]=G.elements[4],S.__data[6]=G.elements[5],S.__data[7]=0,S.__data[8]=G.elements[6],S.__data[9]=G.elements[7],S.__data[10]=G.elements[8],S.__data[11]=0):(G.toArray(S.__data,O),O+=$.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,V,S.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(T,E,A,z){const P=T.value,b=E+"_"+A;if(z[b]===void 0)return typeof P=="number"||typeof P=="boolean"?z[b]=P:z[b]=P.clone(),!0;{const N=z[b];if(typeof P=="number"||typeof P=="boolean"){if(N!==P)return z[b]=P,!0}else if(N.equals(P)===!1)return N.copy(P),!0}return!1}function x(T){const E=T.uniforms;let A=0;const z=16;for(let b=0,N=E.length;b<N;b++){const Z=Array.isArray(E[b])?E[b]:[E[b]];for(let g=0,S=Z.length;g<S;g++){const V=Z[g],w=Array.isArray(V.value)?V.value:[V.value];for(let O=0,W=w.length;O<W;O++){const G=w[O],$=M(G),H=A%z,se=H%$.boundary,le=H+se;A+=se,le!==0&&z-le<$.storage&&(A+=z-le),V.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),V.__offset=A,A+=$.storage}}}const P=A%z;return P>0&&(A+=z-P),T.__size=A,T.__cache={},this}function M(T){const E={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(E.boundary=4,E.storage=4):T.isVector2?(E.boundary=8,E.storage=8):T.isVector3||T.isColor?(E.boundary=16,E.storage=12):T.isVector4?(E.boundary=16,E.storage=16):T.isMatrix3?(E.boundary=48,E.storage=48):T.isMatrix4?(E.boundary=64,E.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),E}function h(T){const E=T.target;E.removeEventListener("dispose",h);const A=a.indexOf(E.__bindingPointIndex);a.splice(A,1),i.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function u(){for(const T in r)i.deleteBuffer(r[T]);a=[],r={},s={}}return{bind:l,update:c,dispose:u}}class Vf{constructor(e={}){const{canvas:t=Rl(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:p=!1}=e;this.isWebGLRenderer=!0;let f;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=n.getContextAttributes().alpha}else f=a;const m=new Uint32Array(4),x=new Int32Array(4);let M=null,h=null;const u=[],T=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Bt,this.toneMapping=Jt,this.toneMappingExposure=1;const E=this;let A=!1,z=0,P=0,b=null,N=-1,Z=null;const g=new et,S=new et;let V=null;const w=new Ye(0);let O=0,W=t.width,G=t.height,$=1,H=null,se=null;const le=new et(0,0,W,G),ge=new et(0,0,W,G);let ze=!1;const We=new Eo;let X=!1,J=!1;const pe=new st,ce=new st,Re=new B,Me=new et,Ue={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let qe=!1;function Ie(){return b===null?$:1}let R=n;function Mt(v,L){return t.getContext(v,L)}try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ls}`),t.addEventListener("webglcontextlost",K,!1),t.addEventListener("webglcontextrestored",ie,!1),t.addEventListener("webglcontextcreationerror",oe,!1),R===null){const L="webgl2";if(R=Mt(L,v),R===null)throw Mt(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw console.error("THREE.WebGLRenderer: "+v.message),v}let Le,Oe,ye,$e,be,y,_,U,Y,j,q,_e,ne,ue,Be,Q,he,Te,Ae,de,De,we,Ke,C;function ae(){Le=new Yh(R),Le.init(),we=new Uf(R,Le),Oe=new Hh(R,Le,e,we),ye=new Pf(R),Oe.reverseDepthBuffer&&ye.buffers.depth.setReversed(!0),$e=new Zh(R),be=new mf,y=new Df(R,Le,ye,be,Oe,we,$e),_=new kh(E),U=new qh(E),Y=new nc(R),Ke=new Bh(R,Y),j=new Kh(R,Y,$e,Ke),q=new Jh(R,j,Y,$e),Ae=new jh(R,Oe,y),Q=new Gh(be),_e=new pf(E,_,U,Le,Oe,Ke,Q),ne=new Gf(E,be),ue=new _f,Be=new yf(Le),Te=new Oh(E,_,U,ye,q,f,l),he=new wf(E,q,Oe),C=new kf(R,$e,Oe,ye),de=new zh(R,Le,$e),De=new $h(R,Le,$e),$e.programs=_e.programs,E.capabilities=Oe,E.extensions=Le,E.properties=be,E.renderLists=ue,E.shadowMap=he,E.state=ye,E.info=$e}ae();const k=new zf(E,R);this.xr=k,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const v=Le.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Le.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return $},this.setPixelRatio=function(v){v!==void 0&&($=v,this.setSize(W,G,!1))},this.getSize=function(v){return v.set(W,G)},this.setSize=function(v,L,I=!0){if(k.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=v,G=L,t.width=Math.floor(v*$),t.height=Math.floor(L*$),I===!0&&(t.style.width=v+"px",t.style.height=L+"px"),this.setViewport(0,0,v,L)},this.getDrawingBufferSize=function(v){return v.set(W*$,G*$).floor()},this.setDrawingBufferSize=function(v,L,I){W=v,G=L,$=I,t.width=Math.floor(v*I),t.height=Math.floor(L*I),this.setViewport(0,0,v,L)},this.getCurrentViewport=function(v){return v.copy(g)},this.getViewport=function(v){return v.copy(le)},this.setViewport=function(v,L,I,F){v.isVector4?le.set(v.x,v.y,v.z,v.w):le.set(v,L,I,F),ye.viewport(g.copy(le).multiplyScalar($).round())},this.getScissor=function(v){return v.copy(ge)},this.setScissor=function(v,L,I,F){v.isVector4?ge.set(v.x,v.y,v.z,v.w):ge.set(v,L,I,F),ye.scissor(S.copy(ge).multiplyScalar($).round())},this.getScissorTest=function(){return ze},this.setScissorTest=function(v){ye.setScissorTest(ze=v)},this.setOpaqueSort=function(v){H=v},this.setTransparentSort=function(v){se=v},this.getClearColor=function(v){return v.copy(Te.getClearColor())},this.setClearColor=function(){Te.setClearColor.apply(Te,arguments)},this.getClearAlpha=function(){return Te.getClearAlpha()},this.setClearAlpha=function(){Te.setClearAlpha.apply(Te,arguments)},this.clear=function(v=!0,L=!0,I=!0){let F=0;if(v){let D=!1;if(b!==null){const ee=b.texture.format;D=ee===Os||ee===Fs||ee===Ns}if(D){const ee=b.texture.type,re=ee===Qt||ee===Cn||ee===pi||ee===ni||ee===Us||ee===Is,fe=Te.getClearColor(),me=Te.getClearAlpha(),Se=fe.r,Ee=fe.g,ve=fe.b;re?(m[0]=Se,m[1]=Ee,m[2]=ve,m[3]=me,R.clearBufferuiv(R.COLOR,0,m)):(x[0]=Se,x[1]=Ee,x[2]=ve,x[3]=me,R.clearBufferiv(R.COLOR,0,x))}else F|=R.COLOR_BUFFER_BIT}L&&(F|=R.DEPTH_BUFFER_BIT,R.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),I&&(F|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),R.clear(F)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",K,!1),t.removeEventListener("webglcontextrestored",ie,!1),t.removeEventListener("webglcontextcreationerror",oe,!1),ue.dispose(),Be.dispose(),be.dispose(),_.dispose(),U.dispose(),q.dispose(),Ke.dispose(),C.dispose(),_e.dispose(),k.dispose(),k.removeEventListener("sessionstart",Vs),k.removeEventListener("sessionend",Ws),gn.stop()};function K(v){v.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),A=!0}function ie(){console.log("THREE.WebGLRenderer: Context Restored."),A=!1;const v=$e.autoReset,L=he.enabled,I=he.autoUpdate,F=he.needsUpdate,D=he.type;ae(),$e.autoReset=v,he.enabled=L,he.autoUpdate=I,he.needsUpdate=F,he.type=D}function oe(v){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function Ne(v){const L=v.target;L.removeEventListener("dispose",Ne),it(L)}function it(v){mt(v),be.remove(v)}function mt(v){const L=be.get(v).programs;L!==void 0&&(L.forEach(function(I){_e.releaseProgram(I)}),v.isShaderMaterial&&_e.releaseShaderCache(v))}this.renderBufferDirect=function(v,L,I,F,D,ee){L===null&&(L=Ue);const re=D.isMesh&&D.matrixWorld.determinant()<0,fe=Do(v,L,I,F,D);ye.setMaterial(F,re);let me=I.index,Se=1;if(F.wireframe===!0){if(me=j.getWireframeAttribute(I),me===void 0)return;Se=2}const Ee=I.drawRange,ve=I.attributes.position;let Xe=Ee.start*Se,Ze=(Ee.start+Ee.count)*Se;ee!==null&&(Xe=Math.max(Xe,ee.start*Se),Ze=Math.min(Ze,(ee.start+ee.count)*Se)),me!==null?(Xe=Math.max(Xe,0),Ze=Math.min(Ze,me.count)):ve!=null&&(Xe=Math.max(Xe,0),Ze=Math.min(Ze,ve.count));const Qe=Ze-Xe;if(Qe<0||Qe===1/0)return;Ke.setup(D,F,fe,I,me);let Et,Ge=de;if(me!==null&&(Et=Y.get(me),Ge=De,Ge.setIndex(Et)),D.isMesh)F.wireframe===!0?(ye.setLineWidth(F.wireframeLinewidth*Ie()),Ge.setMode(R.LINES)):Ge.setMode(R.TRIANGLES);else if(D.isLine){let xe=F.linewidth;xe===void 0&&(xe=1),ye.setLineWidth(xe*Ie()),D.isLineSegments?Ge.setMode(R.LINES):D.isLineLoop?Ge.setMode(R.LINE_LOOP):Ge.setMode(R.LINE_STRIP)}else D.isPoints?Ge.setMode(R.POINTS):D.isSprite&&Ge.setMode(R.TRIANGLES);if(D.isBatchedMesh)if(D._multiDrawInstances!==null)Ge.renderMultiDrawInstances(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount,D._multiDrawInstances);else if(Le.get("WEBGL_multi_draw"))Ge.renderMultiDraw(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount);else{const xe=D._multiDrawStarts,ct=D._multiDrawCounts,ke=D._multiDrawCount,Lt=me?Y.get(me).bytesPerElement:1,Dn=be.get(F).currentProgram.getUniforms();for(let yt=0;yt<ke;yt++)Dn.setValue(R,"_gl_DrawID",yt),Ge.render(xe[yt]/Lt,ct[yt])}else if(D.isInstancedMesh)Ge.renderInstances(Xe,Qe,D.count);else if(I.isInstancedBufferGeometry){const xe=I._maxInstanceCount!==void 0?I._maxInstanceCount:1/0,ct=Math.min(I.instanceCount,xe);Ge.renderInstances(Xe,Qe,ct)}else Ge.render(Xe,Qe)};function He(v,L,I){v.transparent===!0&&v.side===$t&&v.forceSinglePass===!1?(v.side=St,v.needsUpdate=!0,Ei(v,L,I),v.side=mn,v.needsUpdate=!0,Ei(v,L,I),v.side=$t):Ei(v,L,I)}this.compile=function(v,L,I=null){I===null&&(I=v),h=Be.get(I),h.init(L),T.push(h),I.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(h.pushLight(D),D.castShadow&&h.pushShadow(D))}),v!==I&&v.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(h.pushLight(D),D.castShadow&&h.pushShadow(D))}),h.setupLights();const F=new Set;return v.traverse(function(D){if(!(D.isMesh||D.isPoints||D.isLine||D.isSprite))return;const ee=D.material;if(ee)if(Array.isArray(ee))for(let re=0;re<ee.length;re++){const fe=ee[re];He(fe,I,D),F.add(fe)}else He(ee,I,D),F.add(ee)}),T.pop(),h=null,F},this.compileAsync=function(v,L,I=null){const F=this.compile(v,L,I);return new Promise(D=>{function ee(){if(F.forEach(function(re){be.get(re).currentProgram.isReady()&&F.delete(re)}),F.size===0){D(v);return}setTimeout(ee,10)}Le.get("KHR_parallel_shader_compile")!==null?ee():setTimeout(ee,10)})};let gt=null;function kt(v){gt&&gt(v)}function Vs(){gn.stop()}function Ws(){gn.start()}const gn=new yo;gn.setAnimationLoop(kt),typeof self<"u"&&gn.setContext(self),this.setAnimationLoop=function(v){gt=v,k.setAnimationLoop(v),v===null?gn.stop():gn.start()},k.addEventListener("sessionstart",Vs),k.addEventListener("sessionend",Ws),this.render=function(v,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(A===!0)return;if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),k.enabled===!0&&k.isPresenting===!0&&(k.cameraAutoUpdate===!0&&k.updateCamera(L),L=k.getCamera()),v.isScene===!0&&v.onBeforeRender(E,v,L,b),h=Be.get(v,T.length),h.init(L),T.push(h),ce.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),We.setFromProjectionMatrix(ce),J=this.localClippingEnabled,X=Q.init(this.clippingPlanes,J),M=ue.get(v,u.length),M.init(),u.push(M),k.enabled===!0&&k.isPresenting===!0){const ee=E.xr.getDepthSensingMesh();ee!==null&&cr(ee,L,-1/0,E.sortObjects)}cr(v,L,0,E.sortObjects),M.finish(),E.sortObjects===!0&&M.sort(H,se),qe=k.enabled===!1||k.isPresenting===!1||k.hasDepthSensing()===!1,qe&&Te.addToRenderList(M,v),this.info.render.frame++,X===!0&&Q.beginShadows();const I=h.state.shadowsArray;he.render(I,v,L),X===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const F=M.opaque,D=M.transmissive;if(h.setupLights(),L.isArrayCamera){const ee=L.cameras;if(D.length>0)for(let re=0,fe=ee.length;re<fe;re++){const me=ee[re];qs(F,D,v,me)}qe&&Te.render(v);for(let re=0,fe=ee.length;re<fe;re++){const me=ee[re];Xs(M,v,me,me.viewport)}}else D.length>0&&qs(F,D,v,L),qe&&Te.render(v),Xs(M,v,L);b!==null&&(y.updateMultisampleRenderTarget(b),y.updateRenderTargetMipmap(b)),v.isScene===!0&&v.onAfterRender(E,v,L),Ke.resetDefaultState(),N=-1,Z=null,T.pop(),T.length>0?(h=T[T.length-1],X===!0&&Q.setGlobalState(E.clippingPlanes,h.state.camera)):h=null,u.pop(),u.length>0?M=u[u.length-1]:M=null};function cr(v,L,I,F){if(v.visible===!1)return;if(v.layers.test(L.layers)){if(v.isGroup)I=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(L);else if(v.isLight)h.pushLight(v),v.castShadow&&h.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||We.intersectsSprite(v)){F&&Me.setFromMatrixPosition(v.matrixWorld).applyMatrix4(ce);const re=q.update(v),fe=v.material;fe.visible&&M.push(v,re,fe,I,Me.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||We.intersectsObject(v))){const re=q.update(v),fe=v.material;if(F&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Me.copy(v.boundingSphere.center)):(re.boundingSphere===null&&re.computeBoundingSphere(),Me.copy(re.boundingSphere.center)),Me.applyMatrix4(v.matrixWorld).applyMatrix4(ce)),Array.isArray(fe)){const me=re.groups;for(let Se=0,Ee=me.length;Se<Ee;Se++){const ve=me[Se],Xe=fe[ve.materialIndex];Xe&&Xe.visible&&M.push(v,re,Xe,I,Me.z,ve)}}else fe.visible&&M.push(v,re,fe,I,Me.z,null)}}const ee=v.children;for(let re=0,fe=ee.length;re<fe;re++)cr(ee[re],L,I,F)}function Xs(v,L,I,F){const D=v.opaque,ee=v.transmissive,re=v.transparent;h.setupLightsView(I),X===!0&&Q.setGlobalState(E.clippingPlanes,I),F&&ye.viewport(g.copy(F)),D.length>0&&Mi(D,L,I),ee.length>0&&Mi(ee,L,I),re.length>0&&Mi(re,L,I),ye.buffers.depth.setTest(!0),ye.buffers.depth.setMask(!0),ye.buffers.color.setMask(!0),ye.setPolygonOffset(!1)}function qs(v,L,I,F){if((I.isScene===!0?I.overrideMaterial:null)!==null)return;h.state.transmissionRenderTarget[F.id]===void 0&&(h.state.transmissionRenderTarget[F.id]=new Pn(1,1,{generateMipmaps:!0,type:Le.has("EXT_color_buffer_half_float")||Le.has("EXT_color_buffer_float")?mi:Qt,minFilter:fn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ve.workingColorSpace}));const ee=h.state.transmissionRenderTarget[F.id],re=F.viewport||g;ee.setSize(re.z,re.w);const fe=E.getRenderTarget();E.setRenderTarget(ee),E.getClearColor(w),O=E.getClearAlpha(),O<1&&E.setClearColor(16777215,.5),E.clear(),qe&&Te.render(I);const me=E.toneMapping;E.toneMapping=Jt;const Se=F.viewport;if(F.viewport!==void 0&&(F.viewport=void 0),h.setupLightsView(F),X===!0&&Q.setGlobalState(E.clippingPlanes,F),Mi(v,I,F),y.updateMultisampleRenderTarget(ee),y.updateRenderTargetMipmap(ee),Le.has("WEBGL_multisampled_render_to_texture")===!1){let Ee=!1;for(let ve=0,Xe=L.length;ve<Xe;ve++){const Ze=L[ve],Qe=Ze.object,Et=Ze.geometry,Ge=Ze.material,xe=Ze.group;if(Ge.side===$t&&Qe.layers.test(F.layers)){const ct=Ge.side;Ge.side=St,Ge.needsUpdate=!0,Ys(Qe,I,F,Et,Ge,xe),Ge.side=ct,Ge.needsUpdate=!0,Ee=!0}}Ee===!0&&(y.updateMultisampleRenderTarget(ee),y.updateRenderTargetMipmap(ee))}E.setRenderTarget(fe),E.setClearColor(w,O),Se!==void 0&&(F.viewport=Se),E.toneMapping=me}function Mi(v,L,I){const F=L.isScene===!0?L.overrideMaterial:null;for(let D=0,ee=v.length;D<ee;D++){const re=v[D],fe=re.object,me=re.geometry,Se=F===null?re.material:F,Ee=re.group;fe.layers.test(I.layers)&&Ys(fe,L,I,me,Se,Ee)}}function Ys(v,L,I,F,D,ee){v.onBeforeRender(E,L,I,F,D,ee),v.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),D.onBeforeRender(E,L,I,F,v,ee),D.transparent===!0&&D.side===$t&&D.forceSinglePass===!1?(D.side=St,D.needsUpdate=!0,E.renderBufferDirect(I,L,F,D,v,ee),D.side=mn,D.needsUpdate=!0,E.renderBufferDirect(I,L,F,D,v,ee),D.side=$t):E.renderBufferDirect(I,L,F,D,v,ee),v.onAfterRender(E,L,I,F,D,ee)}function Ei(v,L,I){L.isScene!==!0&&(L=Ue);const F=be.get(v),D=h.state.lights,ee=h.state.shadowsArray,re=D.state.version,fe=_e.getParameters(v,D.state,ee,L,I),me=_e.getProgramCacheKey(fe);let Se=F.programs;F.environment=v.isMeshStandardMaterial?L.environment:null,F.fog=L.fog,F.envMap=(v.isMeshStandardMaterial?U:_).get(v.envMap||F.environment),F.envMapRotation=F.environment!==null&&v.envMap===null?L.environmentRotation:v.envMapRotation,Se===void 0&&(v.addEventListener("dispose",Ne),Se=new Map,F.programs=Se);let Ee=Se.get(me);if(Ee!==void 0){if(F.currentProgram===Ee&&F.lightsStateVersion===re)return $s(v,fe),Ee}else fe.uniforms=_e.getUniforms(v),v.onBeforeCompile(fe,E),Ee=_e.acquireProgram(fe,me),Se.set(me,Ee),F.uniforms=fe.uniforms;const ve=F.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(ve.clippingPlanes=Q.uniform),$s(v,fe),F.needsLights=Io(v),F.lightsStateVersion=re,F.needsLights&&(ve.ambientLightColor.value=D.state.ambient,ve.lightProbe.value=D.state.probe,ve.directionalLights.value=D.state.directional,ve.directionalLightShadows.value=D.state.directionalShadow,ve.spotLights.value=D.state.spot,ve.spotLightShadows.value=D.state.spotShadow,ve.rectAreaLights.value=D.state.rectArea,ve.ltc_1.value=D.state.rectAreaLTC1,ve.ltc_2.value=D.state.rectAreaLTC2,ve.pointLights.value=D.state.point,ve.pointLightShadows.value=D.state.pointShadow,ve.hemisphereLights.value=D.state.hemi,ve.directionalShadowMap.value=D.state.directionalShadowMap,ve.directionalShadowMatrix.value=D.state.directionalShadowMatrix,ve.spotShadowMap.value=D.state.spotShadowMap,ve.spotLightMatrix.value=D.state.spotLightMatrix,ve.spotLightMap.value=D.state.spotLightMap,ve.pointShadowMap.value=D.state.pointShadowMap,ve.pointShadowMatrix.value=D.state.pointShadowMatrix),F.currentProgram=Ee,F.uniformsList=null,Ee}function Ks(v){if(v.uniformsList===null){const L=v.currentProgram.getUniforms();v.uniformsList=Qi.seqWithValue(L.seq,v.uniforms)}return v.uniformsList}function $s(v,L){const I=be.get(v);I.outputColorSpace=L.outputColorSpace,I.batching=L.batching,I.batchingColor=L.batchingColor,I.instancing=L.instancing,I.instancingColor=L.instancingColor,I.instancingMorph=L.instancingMorph,I.skinning=L.skinning,I.morphTargets=L.morphTargets,I.morphNormals=L.morphNormals,I.morphColors=L.morphColors,I.morphTargetsCount=L.morphTargetsCount,I.numClippingPlanes=L.numClippingPlanes,I.numIntersection=L.numClipIntersection,I.vertexAlphas=L.vertexAlphas,I.vertexTangents=L.vertexTangents,I.toneMapping=L.toneMapping}function Do(v,L,I,F,D){L.isScene!==!0&&(L=Ue),y.resetTextureUnits();const ee=L.fog,re=F.isMeshStandardMaterial?L.environment:null,fe=b===null?E.outputColorSpace:b.isXRRenderTarget===!0?b.texture.colorSpace:nn,me=(F.isMeshStandardMaterial?U:_).get(F.envMap||re),Se=F.vertexColors===!0&&!!I.attributes.color&&I.attributes.color.itemSize===4,Ee=!!I.attributes.tangent&&(!!F.normalMap||F.anisotropy>0),ve=!!I.morphAttributes.position,Xe=!!I.morphAttributes.normal,Ze=!!I.morphAttributes.color;let Qe=Jt;F.toneMapped&&(b===null||b.isXRRenderTarget===!0)&&(Qe=E.toneMapping);const Et=I.morphAttributes.position||I.morphAttributes.normal||I.morphAttributes.color,Ge=Et!==void 0?Et.length:0,xe=be.get(F),ct=h.state.lights;if(X===!0&&(J===!0||v!==Z)){const wt=v===Z&&F.id===N;Q.setState(F,v,wt)}let ke=!1;F.version===xe.__version?(xe.needsLights&&xe.lightsStateVersion!==ct.state.version||xe.outputColorSpace!==fe||D.isBatchedMesh&&xe.batching===!1||!D.isBatchedMesh&&xe.batching===!0||D.isBatchedMesh&&xe.batchingColor===!0&&D.colorTexture===null||D.isBatchedMesh&&xe.batchingColor===!1&&D.colorTexture!==null||D.isInstancedMesh&&xe.instancing===!1||!D.isInstancedMesh&&xe.instancing===!0||D.isSkinnedMesh&&xe.skinning===!1||!D.isSkinnedMesh&&xe.skinning===!0||D.isInstancedMesh&&xe.instancingColor===!0&&D.instanceColor===null||D.isInstancedMesh&&xe.instancingColor===!1&&D.instanceColor!==null||D.isInstancedMesh&&xe.instancingMorph===!0&&D.morphTexture===null||D.isInstancedMesh&&xe.instancingMorph===!1&&D.morphTexture!==null||xe.envMap!==me||F.fog===!0&&xe.fog!==ee||xe.numClippingPlanes!==void 0&&(xe.numClippingPlanes!==Q.numPlanes||xe.numIntersection!==Q.numIntersection)||xe.vertexAlphas!==Se||xe.vertexTangents!==Ee||xe.morphTargets!==ve||xe.morphNormals!==Xe||xe.morphColors!==Ze||xe.toneMapping!==Qe||xe.morphTargetsCount!==Ge)&&(ke=!0):(ke=!0,xe.__version=F.version);let Lt=xe.currentProgram;ke===!0&&(Lt=Ei(F,L,D));let Dn=!1,yt=!1,ur=!1;const tt=Lt.getUniforms(),rn=xe.uniforms;if(ye.useProgram(Lt.program)&&(Dn=!0,yt=!0,ur=!0),F.id!==N&&(N=F.id,yt=!0),Dn||Z!==v){Oe.reverseDepthBuffer?(pe.copy(v.projectionMatrix),Cl(pe),Pl(pe),tt.setValue(R,"projectionMatrix",pe)):tt.setValue(R,"projectionMatrix",v.projectionMatrix),tt.setValue(R,"viewMatrix",v.matrixWorldInverse);const wt=tt.map.cameraPosition;wt!==void 0&&wt.setValue(R,Re.setFromMatrixPosition(v.matrixWorld)),Oe.logarithmicDepthBuffer&&tt.setValue(R,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(F.isMeshPhongMaterial||F.isMeshToonMaterial||F.isMeshLambertMaterial||F.isMeshBasicMaterial||F.isMeshStandardMaterial||F.isShaderMaterial)&&tt.setValue(R,"isOrthographic",v.isOrthographicCamera===!0),Z!==v&&(Z=v,yt=!0,ur=!0)}if(D.isSkinnedMesh){tt.setOptional(R,D,"bindMatrix"),tt.setOptional(R,D,"bindMatrixInverse");const wt=D.skeleton;wt&&(wt.boneTexture===null&&wt.computeBoneTexture(),tt.setValue(R,"boneTexture",wt.boneTexture,y))}D.isBatchedMesh&&(tt.setOptional(R,D,"batchingTexture"),tt.setValue(R,"batchingTexture",D._matricesTexture,y),tt.setOptional(R,D,"batchingIdTexture"),tt.setValue(R,"batchingIdTexture",D._indirectTexture,y),tt.setOptional(R,D,"batchingColorTexture"),D._colorsTexture!==null&&tt.setValue(R,"batchingColorTexture",D._colorsTexture,y));const hr=I.morphAttributes;if((hr.position!==void 0||hr.normal!==void 0||hr.color!==void 0)&&Ae.update(D,I,Lt),(yt||xe.receiveShadow!==D.receiveShadow)&&(xe.receiveShadow=D.receiveShadow,tt.setValue(R,"receiveShadow",D.receiveShadow)),F.isMeshGouraudMaterial&&F.envMap!==null&&(rn.envMap.value=me,rn.flipEnvMap.value=me.isCubeTexture&&me.isRenderTargetTexture===!1?-1:1),F.isMeshStandardMaterial&&F.envMap===null&&L.environment!==null&&(rn.envMapIntensity.value=L.environmentIntensity),yt&&(tt.setValue(R,"toneMappingExposure",E.toneMappingExposure),xe.needsLights&&Uo(rn,ur),ee&&F.fog===!0&&ne.refreshFogUniforms(rn,ee),ne.refreshMaterialUniforms(rn,F,$,G,h.state.transmissionRenderTarget[v.id]),Qi.upload(R,Ks(xe),rn,y)),F.isShaderMaterial&&F.uniformsNeedUpdate===!0&&(Qi.upload(R,Ks(xe),rn,y),F.uniformsNeedUpdate=!1),F.isSpriteMaterial&&tt.setValue(R,"center",D.center),tt.setValue(R,"modelViewMatrix",D.modelViewMatrix),tt.setValue(R,"normalMatrix",D.normalMatrix),tt.setValue(R,"modelMatrix",D.matrixWorld),F.isShaderMaterial||F.isRawShaderMaterial){const wt=F.uniformsGroups;for(let dr=0,No=wt.length;dr<No;dr++){const Zs=wt[dr];C.update(Zs,Lt),C.bind(Zs,Lt)}}return Lt}function Uo(v,L){v.ambientLightColor.needsUpdate=L,v.lightProbe.needsUpdate=L,v.directionalLights.needsUpdate=L,v.directionalLightShadows.needsUpdate=L,v.pointLights.needsUpdate=L,v.pointLightShadows.needsUpdate=L,v.spotLights.needsUpdate=L,v.spotLightShadows.needsUpdate=L,v.rectAreaLights.needsUpdate=L,v.hemisphereLights.needsUpdate=L}function Io(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return z},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return b},this.setRenderTargetTextures=function(v,L,I){be.get(v.texture).__webglTexture=L,be.get(v.depthTexture).__webglTexture=I;const F=be.get(v);F.__hasExternalTextures=!0,F.__autoAllocateDepthBuffer=I===void 0,F.__autoAllocateDepthBuffer||Le.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),F.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(v,L){const I=be.get(v);I.__webglFramebuffer=L,I.__useDefaultFramebuffer=L===void 0},this.setRenderTarget=function(v,L=0,I=0){b=v,z=L,P=I;let F=!0,D=null,ee=!1,re=!1;if(v){const me=be.get(v);if(me.__useDefaultFramebuffer!==void 0)ye.bindFramebuffer(R.FRAMEBUFFER,null),F=!1;else if(me.__webglFramebuffer===void 0)y.setupRenderTarget(v);else if(me.__hasExternalTextures)y.rebindTextures(v,be.get(v.texture).__webglTexture,be.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const ve=v.depthTexture;if(me.__boundDepthTexture!==ve){if(ve!==null&&be.has(ve)&&(v.width!==ve.image.width||v.height!==ve.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");y.setupDepthRenderbuffer(v)}}const Se=v.texture;(Se.isData3DTexture||Se.isDataArrayTexture||Se.isCompressedArrayTexture)&&(re=!0);const Ee=be.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ee[L])?D=Ee[L][I]:D=Ee[L],ee=!0):v.samples>0&&y.useMultisampledRTT(v)===!1?D=be.get(v).__webglMultisampledFramebuffer:Array.isArray(Ee)?D=Ee[I]:D=Ee,g.copy(v.viewport),S.copy(v.scissor),V=v.scissorTest}else g.copy(le).multiplyScalar($).floor(),S.copy(ge).multiplyScalar($).floor(),V=ze;if(ye.bindFramebuffer(R.FRAMEBUFFER,D)&&F&&ye.drawBuffers(v,D),ye.viewport(g),ye.scissor(S),ye.setScissorTest(V),ee){const me=be.get(v.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+L,me.__webglTexture,I)}else if(re){const me=be.get(v.texture),Se=L||0;R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,me.__webglTexture,I||0,Se)}N=-1},this.readRenderTargetPixels=function(v,L,I,F,D,ee,re){if(!(v&&v.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let fe=be.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&re!==void 0&&(fe=fe[re]),fe){ye.bindFramebuffer(R.FRAMEBUFFER,fe);try{const me=v.texture,Se=me.format,Ee=me.type;if(!Oe.textureFormatReadable(Se)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Oe.textureTypeReadable(Ee)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=v.width-F&&I>=0&&I<=v.height-D&&R.readPixels(L,I,F,D,we.convert(Se),we.convert(Ee),ee)}finally{const me=b!==null?be.get(b).__webglFramebuffer:null;ye.bindFramebuffer(R.FRAMEBUFFER,me)}}},this.readRenderTargetPixelsAsync=async function(v,L,I,F,D,ee,re){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let fe=be.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&re!==void 0&&(fe=fe[re]),fe){const me=v.texture,Se=me.format,Ee=me.type;if(!Oe.textureFormatReadable(Se))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Oe.textureTypeReadable(Ee))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(L>=0&&L<=v.width-F&&I>=0&&I<=v.height-D){ye.bindFramebuffer(R.FRAMEBUFFER,fe);const ve=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,ve),R.bufferData(R.PIXEL_PACK_BUFFER,ee.byteLength,R.STREAM_READ),R.readPixels(L,I,F,D,we.convert(Se),we.convert(Ee),0);const Xe=b!==null?be.get(b).__webglFramebuffer:null;ye.bindFramebuffer(R.FRAMEBUFFER,Xe);const Ze=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await wl(R,Ze,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,ve),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,ee),R.deleteBuffer(ve),R.deleteSync(Ze),ee}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(v,L=null,I=0){v.isTexture!==!0&&(Ji("WebGLRenderer: copyFramebufferToTexture function signature has changed."),L=arguments[0]||null,v=arguments[1]);const F=Math.pow(2,-I),D=Math.floor(v.image.width*F),ee=Math.floor(v.image.height*F),re=L!==null?L.x:0,fe=L!==null?L.y:0;y.setTexture2D(v,0),R.copyTexSubImage2D(R.TEXTURE_2D,I,0,0,re,fe,D,ee),ye.unbindTexture()},this.copyTextureToTexture=function(v,L,I=null,F=null,D=0){v.isTexture!==!0&&(Ji("WebGLRenderer: copyTextureToTexture function signature has changed."),F=arguments[0]||null,v=arguments[1],L=arguments[2],D=arguments[3]||0,I=null);let ee,re,fe,me,Se,Ee;I!==null?(ee=I.max.x-I.min.x,re=I.max.y-I.min.y,fe=I.min.x,me=I.min.y):(ee=v.image.width,re=v.image.height,fe=0,me=0),F!==null?(Se=F.x,Ee=F.y):(Se=0,Ee=0);const ve=we.convert(L.format),Xe=we.convert(L.type);y.setTexture2D(L,0),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,L.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,L.unpackAlignment);const Ze=R.getParameter(R.UNPACK_ROW_LENGTH),Qe=R.getParameter(R.UNPACK_IMAGE_HEIGHT),Et=R.getParameter(R.UNPACK_SKIP_PIXELS),Ge=R.getParameter(R.UNPACK_SKIP_ROWS),xe=R.getParameter(R.UNPACK_SKIP_IMAGES),ct=v.isCompressedTexture?v.mipmaps[D]:v.image;R.pixelStorei(R.UNPACK_ROW_LENGTH,ct.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,ct.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,fe),R.pixelStorei(R.UNPACK_SKIP_ROWS,me),v.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,D,Se,Ee,ee,re,ve,Xe,ct.data):v.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,D,Se,Ee,ct.width,ct.height,ve,ct.data):R.texSubImage2D(R.TEXTURE_2D,D,Se,Ee,ee,re,ve,Xe,ct),R.pixelStorei(R.UNPACK_ROW_LENGTH,Ze),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,Qe),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Et),R.pixelStorei(R.UNPACK_SKIP_ROWS,Ge),R.pixelStorei(R.UNPACK_SKIP_IMAGES,xe),D===0&&L.generateMipmaps&&R.generateMipmap(R.TEXTURE_2D),ye.unbindTexture()},this.copyTextureToTexture3D=function(v,L,I=null,F=null,D=0){v.isTexture!==!0&&(Ji("WebGLRenderer: copyTextureToTexture3D function signature has changed."),I=arguments[0]||null,F=arguments[1]||null,v=arguments[2],L=arguments[3],D=arguments[4]||0);let ee,re,fe,me,Se,Ee,ve,Xe,Ze;const Qe=v.isCompressedTexture?v.mipmaps[D]:v.image;I!==null?(ee=I.max.x-I.min.x,re=I.max.y-I.min.y,fe=I.max.z-I.min.z,me=I.min.x,Se=I.min.y,Ee=I.min.z):(ee=Qe.width,re=Qe.height,fe=Qe.depth,me=0,Se=0,Ee=0),F!==null?(ve=F.x,Xe=F.y,Ze=F.z):(ve=0,Xe=0,Ze=0);const Et=we.convert(L.format),Ge=we.convert(L.type);let xe;if(L.isData3DTexture)y.setTexture3D(L,0),xe=R.TEXTURE_3D;else if(L.isDataArrayTexture||L.isCompressedArrayTexture)y.setTexture2DArray(L,0),xe=R.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,L.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,L.unpackAlignment);const ct=R.getParameter(R.UNPACK_ROW_LENGTH),ke=R.getParameter(R.UNPACK_IMAGE_HEIGHT),Lt=R.getParameter(R.UNPACK_SKIP_PIXELS),Dn=R.getParameter(R.UNPACK_SKIP_ROWS),yt=R.getParameter(R.UNPACK_SKIP_IMAGES);R.pixelStorei(R.UNPACK_ROW_LENGTH,Qe.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,Qe.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,me),R.pixelStorei(R.UNPACK_SKIP_ROWS,Se),R.pixelStorei(R.UNPACK_SKIP_IMAGES,Ee),v.isDataTexture||v.isData3DTexture?R.texSubImage3D(xe,D,ve,Xe,Ze,ee,re,fe,Et,Ge,Qe.data):L.isCompressedArrayTexture?R.compressedTexSubImage3D(xe,D,ve,Xe,Ze,ee,re,fe,Et,Qe.data):R.texSubImage3D(xe,D,ve,Xe,Ze,ee,re,fe,Et,Ge,Qe),R.pixelStorei(R.UNPACK_ROW_LENGTH,ct),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,ke),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Lt),R.pixelStorei(R.UNPACK_SKIP_ROWS,Dn),R.pixelStorei(R.UNPACK_SKIP_IMAGES,yt),D===0&&L.generateMipmaps&&R.generateMipmap(xe),ye.unbindTexture()},this.initRenderTarget=function(v){be.get(v).__webglFramebuffer===void 0&&y.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?y.setTextureCube(v,0):v.isData3DTexture?y.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?y.setTexture2DArray(v,0):y.setTexture2D(v,0),ye.unbindTexture()},this.resetState=function(){z=0,P=0,b=null,ye.reset(),Ke.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return jt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Bs?"display-p3":"srgb",t.unpackColorSpace=Ve.workingColorSpace===ar?"display-p3":"srgb"}}class Wf extends Rt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new en,this.environmentIntensity=1,this.environmentRotation=new en,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class Xf extends ut{constructor(e=null,t=1,n=1,r,s,a,o,l,c=ft,d=ft,p,f){super(null,a,o,l,c,d,r,s,p,f),this.isDataTexture=!0,this.image={data:e,width:t,height:n},this.generateMipmaps=!1,this.flipY=!1,this.unpackAlignment=1}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Ls}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Ls);const qf=`//
// 2D Simplex noise
...
`)}const Ka=[{key:"windStrength",label:"Wind Strength",min:0,max:1,step:.01,suffix:"",decimals:2,apply:(i,e)=>i.setWindStrength(e)},{key:"windDirection",label:"Wind Direction",min:0,max:360,step:1,suffix:"°",decimals:0,apply:(i,e)=>i.setWindDirection(e)},{key:"animationSpeed",label:"Animation Speed",min:.1,max:2,step:.01,suffix:"×",decimals:2,apply:(i,e)=>i.setAnimationSpeed(e)},{key:"movementScale",label:"Movement Scale",min:0,max:2,step:.01,suffix:"×",decimals:2,apply:(i,e)=>i.setMovementScale(e)},{key:"fogStrength",label:"Fog Strength",min:0,max:.5,step:.005,suffix:"",decimals:3,apply:(i,e)=>i.setFogStrength(e)},{key:"fogSpeed",label:"Fog Speed",min:0,max:8,step:.1,suffix:"×",decimals:2,apply:(i,e)=>i.setFogSpeed(e)}],rp="e";function sp(i,e,t=!1){const n=document.createElement("div");n.id="debug",n.classList.add("panel-hidden");const r=document.createElement("div");r.className="dbg-head";const s=document.createElement("span");s.textContent="DEBUG";const a=document.createElement("span");a.textContent="−",r.append(s,a);const o=document.createElement("div");o.className="dbg-body",r.addEventListener("click",()=>{const w=n.classList.toggle("collapsed");a.textContent=w?"+":"−"});const l=new Map,c=new Map;for(const w of Ka){const O=document.createElement("div");O.className="row";const W=document.createElement("label"),G=document.createElement("span");G.textContent=w.label;const $=document.createElement("b");W.append(G,$);const H=document.createElement("input");H.type="range",H.min=String(w.min),H.max=String(w.max),H.step=String(w.step),H.value=String(i.getConfig()[w.key]);const se=()=>{const le=Number(H.value);$.textContent=le.toFixed(w.decimals)+w.suffix};se(),H.addEventListener("input",()=>{w.apply(i,Number(H.value)),se(),S()}),O.append(W,H),o.appendChild(O),l.set(w.key,H),c.set(w.key,$)}const d=document.createElement("div");d.className="row";const p=document.createElement("label"),f=document.createElement("span");f.textContent="Movement Mode",p.appendChild(f);const m=document.createElement("select");for(const w of["SIMPLE","ADVANCED"]){const O=document.createElement("option");O.value=w,O.textContent=w,m.appendChild(O)}m.value=i.getConfig().movementMode,m.addEventListener("change",()=>{i.setMovementMode(m.value)}),d.append(p,m),o.appendChild(d);const x=document.createElement("div");x.className="checks";const M=document.createElement("input");M.type="checkbox",M.id="dbg-mask",M.checked=i.getConfig().maskEnabled;const h=document.createElement("label");h.htmlFor="dbg-mask",h.textContent=M.checked?"Mask ON":"Mask OFF",M.addEventListener("change",()=>{i.setMaskEnabled(M.checked),h.textContent=M.checked?"Mask ON":"Mask OFF"}),x.append(M,h),o.appendChild(x);const u=document.createElement("div");u.className="buttons";let T=0;const E=(w,O,W)=>{T!==0&&window.clearTimeout(T),w.textContent=O,T=window.setTimeout(()=>{w.textContent=W,T=0},1400)},A=document.createElement("button");A.textContent="Save",A.title="把目前滑桿數值存進 localStorage，並複製 config.ts 片段到剪貼簿",A.addEventListener("click",()=>{const w=i.getConfig(),O=tp(w),W=ip(w);navigator.clipboard?.writeText(W).catch(()=>{console.info(`[forest-breeze] 剪貼簿不可用，以下是設定片段：
`+W)}),console.info(`[forest-breeze] 已儲存設定：
`+W),E(A,O?"Saved ✓":"No storage","Save"),b.textContent=O?"已儲存：重新整理會自動套用":"! localStorage 不可用，設定沒有存下來",b.className=O?"saved-note":"saved-note warn"});const z=document.createElement("button");z.textContent="Pause",z.addEventListener("click",()=>{const w=!i.getConfig().paused;i.setPaused(w),z.textContent=w?"Play":"Pause"});const P=document.createElement("button");P.textContent="Reset",P.title="回到 config.ts 的預設值，並清除已儲存的設定",P.addEventListener("click",()=>{np(),i.reset();for(const w of Ka){const O=l.get(w.key);O.value=String(nt[w.key]),c.get(w.key).textContent=Number(O.value).toFixed(w.decimals)+w.suffix}M.checked=nt.maskEnabled,h.textContent="Mask ON",m.value=nt.movementMode,z.textContent="Pause",b.textContent="已清除儲存的設定",b.className="saved-note",S()}),u.append(A,z,P),o.appendChild(u);const b=document.createElement("div");b.className="saved-note",b.textContent=t?"已套用儲存的設定":"",o.appendChild(b);const N=document.createElement("div");N.className="info";const Z=new Map,g=["Source texture","Mask texture","Canvas CSS","Canvas internal","Image on screen","Image rendered at","Texel sampling","devicePixelRatio","Render pixelRatio","GPU max texture","Max disp. GRAY","Max disp. BLACK"];for(const w of g){const O=document.createElement("div"),W=document.createElement("em");W.style.fontStyle="normal",W.textContent=w;const G=document.createElement("span");O.append(W,G),N.appendChild(O),Z.set(w,G)}for(const w of e){const O=document.createElement("div");O.className="warn",O.style.display="block",O.textContent=w,N.appendChild(O)}o.appendChild(N);const S=()=>{const w=i.getMetrics();Z.get("Source texture").textContent=`${w.textureWidth} × ${w.textureHeight}`,Z.get("Mask texture").textContent=`${w.maskWidth} × ${w.maskHeight}`,Z.get("Canvas CSS").textContent=`${w.cssWidth} × ${w.cssHeight}`,Z.get("Canvas internal").textContent=`${w.bufferWidth} × ${w.bufferHeight}`,Z.get("Image on screen").textContent=`${w.displayWidth} × ${w.displayHeight}`,Z.get("Image rendered at").textContent=`${w.renderedImageWidth} px`;const O=Z.get("Texel sampling");O.textContent=`${w.samplingRatio.toFixed(2)}×`,O.style.color=w.samplingRatio>=.999?"#7fd48a":"#ffb266",Z.get("devicePixelRatio").textContent=w.devicePixelRatio.toFixed(2),Z.get("Render pixelRatio").textContent=w.pixelRatio.toFixed(2),Z.get("GPU max texture").textContent=String(w.maxTextureSize),Z.get("Max disp. GRAY").textContent=`${w.effectiveMidPx.toFixed(2)} px`,Z.get("Max disp. BLACK").textContent=`${w.effectiveStrongPx.toFixed(2)} px`};S(),n.append(r,o),document.body.appendChild(n),i.onResized=S;const V=w=>{if(w.key.toLowerCase()!==rp||w.ctrlKey||w.metaKey||w.altKey)return;const O=w.target;if(O?.isContentEditable)return;const W=O?.tagName;if(W==="INPUT"&&O.type==="text"||W==="TEXTAREA"||W==="SELECT")return;w.preventDefault(),n.classList.toggle("panel-hidden")||S()};return window.addEventListener("keydown",V),{refresh:S,dispose(){T!==0&&window.clearTimeout(T),window.removeEventListener("keydown",V),i.onResized=null,n.remove()}}}function Po(i){return new Promise((e,t)=>{const n=new Image;n.decoding="async",n.onload=()=>e(n),n.onerror=()=>t(new Error(`無法載入圖片：${i}`)),n.src=i})}async function ap(i){const e=await Po(i),t=new ut(e);return t.colorSpace=Ft,t.wrapS=bt,t.wrapT=bt,t.magFilter=xt,t.generateMipmaps=Co.mipmaps,t.minFilter=fn,t.needsUpdate=!0,{texture:t,width:e.naturalWidth,height:e.naturalHeight}}async function op(i){const e=await Po(i),t=new ut(e);return t.colorSpace=Ft,t.wrapS=bt,t.wrapT=bt,t.magFilter=xt,t.minFilter=xt,t.generateMipmaps=!1,t.needsUpdate=!0,{texture:t,width:e.naturalWidth,height:e.naturalHeight}}function lp(){const i=new Uint8Array([0,0,0,255]),e=new Xf(i,1,1,Pt);return e.colorSpace=Ft,e.wrapS=bt,e.wrapT=bt,e.magFilter=ft,e.minFilter=ft,e.generateMipmaps=!1,e.needsUpdate=!0,{texture:e,width:1,height:1}}const Lo=document.getElementById("app"),wn=document.getElementById("status");if(!Lo||!wn)throw new Error("index.html 缺少 #app 或 #status 元素");function $a(i){return`/forest-breeze/${i}`}function Za(i,e){wn.className="error",wn.innerHTML="";const t=document.createElement("div");t.textContent=`⚠ ${i}`;const n=document.createElement("div");n.style.color="#c9c9c9",n.style.marginTop="6px",n.style.whiteSpace="pre-wrap",n.textContent=e,wn.append(t,n)}async function cp(){wn.textContent=`Loading ${hn.forest} …`;let i;try{i=await ap($a(hn.forest))}catch{Za(`無法載入 ${hn.forest}`,`請把高解析森林照片放在：
  public/${hn.forest}

dev server 會以 /${hn.forest} 提供這個檔案。`);return}wn.textContent=`Loading ${hn.mask} …`;const e=[];let t;try{t=await op($a(hn.mask)),(t.width!==i.width||t.height!==i.height)&&e.push(`! mask 尺寸 ${t.width}×${t.height} 與照片 ${i.width}×${i.height} 不同`)}catch{t=lp(),e.push("! movement-mask.png 載入失敗，已改用全黑 mask（畫面靜止）"),console.warn(`[forest-breeze] 找不到 public/${hn.mask}，改用全黑 mask，畫面會維持靜止。`)}let n;try{n=new Qf(Lo,i,t)}catch(a){Za("WebGL 初始化失敗",a instanceof Error?a.message:String(a));return}const r=ep();r&&n.applyConfig(r);const s=n.getMetrics();(s.textureWidth>s.maxTextureSize||s.textureHeight>s.maxTextureSize)&&(e.push(`! 圖片 ${s.textureWidth}px 超過 GPU 上限 ${s.maxTextureSize}px`),console.error(`[forest-breeze] forest.jpg (${s.textureWidth}×${s.textureHeight}) 超過此 GPU 的 MAX_TEXTURE_SIZE (${s.maxTextureSize})，無法上傳。`)),sp(n,e,r!==null),n.start(),wn.className="hidden",console.info(`[forest-breeze] source texture ${s.textureWidth}×${s.textureHeight} (mipmap level 0 = 原生解析度) | canvas buffer ${s.bufferWidth}×${s.bufferHeight} | dpr ${s.devicePixelRatio}`)}cp();
